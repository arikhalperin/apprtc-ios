...
export LIBFILES='/obj/webrtc/examples/libapprtc_common.a obj/webrtc/examples/libapprtc_signaling.a
...
export SIMULATOR_LIBFILES='obj/webrtc/common_audio/libcommon_audio_sse2.a
 ...
 ninja -C out/Debug-device-arm64 AppRTCMobile
 ...
 #ninja -C out/Debug-sim64  AppRTCMobile
...
pwd
ls
#lipo -create Debug-sim32/libWebRTC-sim32-full.a Debug-sim64/libWebRTC-sim64-full.a Debug-device-arm32/libWebRTC-arm32-full.a Debug-device-arm64/libWebRTC-arm64-full.a -output libWebRTC.a
lipo -create Debug-device-arm32/libWebRTC-arm32-full.a Debug-device-arm64/libWebRTC-arm64-full.a -output libWebRTC.a
